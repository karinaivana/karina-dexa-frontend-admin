      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            title: const AutoSizeText('Buat Karyawan Baru', maxLines: 1),
            onTap: () async => {
          ...
          ListTile(
            ...
            title: const AutoSizeText('Data Karyawan', maxLines: 1),
            onTap: () => {Navigator.of(context).pushNamed(RoutesName.EMPLOYEE)},
          ),
          ListTile(
            leading: const Icon(Icons.exit_to_app),
            title: const AutoSizeText('Keluar', maxLines: 1),
            onTap: () async => {
              await sharedPref.remove("admin_data"),
